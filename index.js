const contentLetterSrart_actived = "Món quà nhỏ cho bạn." //Lời mở đầu cho bức thư
const mainContentLetter = `Chúc mừng sinh nhật, người bạn xinh đẹp và tuyệt vời nhất trong lòng tôi! 🎂🎉

Nhân dịp này, mong rằng bạn sẽ được bao quanh bởi những người thân yêu và những điều tốt đẹp nhất. Hãy tận hưởng mỗi khoảnh khắc, làm những điều mà bạn yêu thích và để nụ cười luôn sáng loá trên khuôn mặt xinh đẹp của bạn.

Chúc bạn có một ngày sinh nhật thật ý nghĩa và đáng nhớ! 🥳🎈`
